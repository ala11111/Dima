...
class StockMoveInherit(models.Model):
    ...
    def _generate_valuation_lines_data(self, partner_id, qty, debit_value, credit_value, debit_account_id, credit_account_id, description):
        ...
        account_credit_account=self.env['account.account'].sudo().search([('id','=',credit_account_id)],limit=1)
        ...
        elif account_credit_account.user_type_id.id == self.env.ref('account.data_account_type_expenses').id:
